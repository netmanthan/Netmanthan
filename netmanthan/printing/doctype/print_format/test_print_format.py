...
test_records = netmanthan.get_test_records("Print Format")


class TestPrintFormat(netmanthanTestCase):
	def test_print_user(self, style=None):
		print_html = netmanthan.get_print("User", "Administrator", style=style)
