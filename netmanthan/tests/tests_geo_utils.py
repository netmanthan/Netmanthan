...
import netmanthan
from netmanthan.geo.utils import get_coords
from netmanthan.tests.utils import netmanthanTestCase


class TestGeoUtils(netmanthanTestCase):
	def setUp(self):
		self.todo = netmanthan.get_doc(
		...
		self.test_location = netmanthan.get_doc(
	...
	def test_get_coords_from_not_existable_location(self):
		self.assertRaises(
			netmanthan.ValidationError, get_coords, "ToDo", self.test_filter_todo, "location_field"
		)

	def test_get_coords_from_not_existable_coords(self):
		self.assertRaises(
			netmanthan.ValidationError, get_coords, "ToDo", self.test_filter_todo, "coordinates"
		)
