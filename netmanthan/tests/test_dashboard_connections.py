...
from netmanthan.desk.notifications import get_open_count
from netmanthan.tests.utils import netmanthanTestCase


class TestDashboardConnections(netmanthanTestCase):
...
def delete_test_data():
	...
	for doctype in doctypes:
		if netmanthan.db.table_exists(doctype):
			netmanthan.db.delete(doctype)
			netmanthan.delete_doc("DocType", doctype, force=True)
...
def add_links_in_child_tables():
	child_table_with_link_to_doctype_a = netmanthan.get_doc(
	...
	child_table_with_link_to_doctype_b = netmanthan.get_doc(
