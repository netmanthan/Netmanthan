...
from netmanthan.utils import format_date, today
from netmanthan.utils.goal import get_monthly_goal_graph_data, get_monthly_results


class TestGoal(netmanthanTestCase):
	def setUp(self):
	...
	def test_get_monthly_goal_graph_data(self):
		...
		docname = netmanthan.get_list("Event", filters={"subject": ["=", "_Test Event 1"]})[0]["name"]
		netmanthan.db.set_value("Event", docname, "description", 1)
