...
import netmanthan
from netmanthan.modules.patch_handler import get_all_patches
from netmanthan.utils.boilerplate import (
	PatchCreator,
...
class TestBoilerPlate(unittest.TestCase):
	...
	def setUpClass(cls):
		super().setUpClass()
		cls.default_hooks = netmanthan._dict(
			{
				"app_name": "test_app",
				"app_title": "Test App",
		...
		cls.default_user_input = netmanthan._dict(
			{
				"title": "Test App",
		...
		cls.bench_path = netmanthan.utils.get_bench_path()
	...
	def test_new_patch_util(self):
		...
		patches_txt = pathlib.Path(pathlib.Path(netmanthan.get_app_path("netmanthan", "patches.txt")))
		...
		expected_patch = "netmanthan.core.doctype.user.patches.delete_all_users"
