...
from netmanthan.utils import cint, cstr, get_system_timezone
...
class TokenCache(Document):
	def get_auth_header(self):
		...
		raise netmanthan.exceptions.DoesNotExistError
	...
	def update_data(self, data):
		...
		if token_type not in ["bearer", "mac"]:
			netmanthan.throw(_("Received an invalid token type."))
		# 'Bearer' or 'MAC'
	...
	def get_expires_in(self):
		...
		modified = netmanthan.utils.get_datetime(self.modified)
