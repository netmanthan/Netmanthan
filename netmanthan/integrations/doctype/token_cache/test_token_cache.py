...
class TestTokenCache(netmanthanTestCase):
	def setUp(self):
		self.token_cache = netmanthan.get_last_doc("Token Cache")
		self.token_cache.update({"connected_app": netmanthan.get_last_doc("Connected App").name})
