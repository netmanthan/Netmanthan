...
def netmanthancloud_migrator(local_site):
	print("Retrieving Site Migrator...")
	remote_site = netmanthan.conf.netmanthancloud_url or "netmanthancloud.com"
	...
	if request.status_code / 100 != 2:
		...
		click.secho(
			"Some errors occurred while recovering the migration script. Please contact us @ netmanthan Cloud if this issue persists",
			fg="yellow",
		)
		return
