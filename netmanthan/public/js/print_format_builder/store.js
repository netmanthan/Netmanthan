		...
		methods: {
			fetch() {
				return new Promise((resolve) => {
					netmanthan.model.clear_doc("Print Format", this.print_format_name);
					netmanthan.model.with_doc("Print Format", this.print_format_name, () => {
						let print_format = netmanthan.get_doc("Print Format", this.print_format_name);
						netmanthan.model.with_doctype(print_format.doc_type, () => {
							this.meta = netmanthan.get_meta(print_format.doc_type);
			...
			save_changes() {
				netmanthan.dom.freeze(__("Saving..."));
			...
			change_letterhead(letterhead) {
				return netmanthan.db.get_doc("Letter Head", letterhead).then((doc) => {
					this.letterhead = doc;
				});
			},
		},
