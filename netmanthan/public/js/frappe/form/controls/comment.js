...
netmanthan.ui.form.ControlComment = class ControlComment extends netmanthan.ui.form.ControlTextEditor {
	make_wrapper() {
		this.comment_wrapper = !this.no_wrapper
			...
			<div class="comment-input-wrapper">
				...
				<div class="comment-input-container">
					<div class="netmanthan-control"></div>
		...
		// wrapper should point to netmanthan-control
		this.$wrapper = !this.no_wrapper
			? this.comment_wrapper.find(".netmanthan-control")
