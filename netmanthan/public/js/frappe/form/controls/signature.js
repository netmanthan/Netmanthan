netmanthan.ui.form.ControlSignature = class ControlSignature extends netmanthan.ui.form.ControlData {
	make() {
		var me = this;
		this.saving = false;
		this.loading = false;
		...
		netmanthan.require("/assets/netmanthan/js/lib/jSignature.min.js").then(() => {
		...
		this.img_wrapper = $(`<div class="signature-display">
			<div class="missing-image attach-missing-image">
				${netmanthan.utils.icon("restriction", "md")}</i>
