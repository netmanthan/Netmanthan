netmanthan.ui.form.ControlMarkdownEditor = class ControlMarkdownEditor extends (
	netmanthan.ui.form.ControlCode
) {
	...
	update_preview() {
		...
		this.markdown_preview.html(netmanthan.markdown(value));
	}
