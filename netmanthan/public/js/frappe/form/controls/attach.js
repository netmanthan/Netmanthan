netmanthan.ui.form.ControlAttach = class ControlAttach extends netmanthan.ui.form.ControlData {
	make_input() {
		let me = this;
		...
		netmanthan.utils.bind_actions_with_object(this.$value, this);
	...
	on_attach_click() {
		...
		this.file_uploader = new netmanthan.ui.FileUploader(this.upload_options);
	}
	on_attach_doc_image() {
		this.set_upload_options();
