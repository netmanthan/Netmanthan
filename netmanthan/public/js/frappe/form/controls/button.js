netmanthan.ui.form.ControlButton = class ControlButton extends netmanthan.ui.form.ControlData {
	can_write() {
	...
	set_label(label) {
		...
		label = (this.df.icon ? netmanthan.utils.icon(this.df.icon) : "") + __(this.df.label);
