netmanthan.ui.form.ControlCode = class ControlCode extends netmanthan.ui.form.ControlText {
	make_input() {
	...
	load_lib() {
		...
		if (netmanthan.boot.developer_mode) {
			this.root_lib_path = "/assets/netmanthan/node_modules/ace-builds/src-noconflict/";
		} else {
			this.root_lib_path = "/assets/netmanthan/node_modules/ace-builds/src-min-noconflict/";
		}

		this.library_loaded = new Promise((resolve) => {
			netmanthan.require(this.root_lib_path + "ace.js", () => {
