netmanthan.ui.form.ControlFloat = class ControlFloat extends netmanthan.ui.form.ControlInt {
	make_input() {
		super.make_input();
	...
	get_number_format() {
		var currency = netmanthan.meta.get_field_currency(this.df, this.get_doc());
		return get_number_format(currency);
	}

	get_precision() {
		// round based on field precision or float precision, else don't round
		return this.df.precision || cint(netmanthan.boot.sysdefaults.float_precision, null);
	}
};

netmanthan.ui.form.ControlPercent = netmanthan.ui.form.ControlFloat;
