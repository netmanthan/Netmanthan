netmanthan.ui.form.ControlPassword = class ControlPassword extends netmanthan.ui.form.ControlData {
	...
	get_password_strength(value) {
		...
		netmanthan.call({
			type: "POST",
			method: "netmanthan.core.doctype.user.user.test_password_strength",
			args: {
				new_password: value || "",
			},
			callback: function (r) {
