netmanthan.views.TranslationManager = class TranslationManager {
	constructor(opts) {
	...
	get_translations_data() {
		return netmanthan.db.get_list("Translation", {
	...
	update_translations({ source, translation_data = [] }) {
		...
		return netmanthan
			.call({
				method: "netmanthan.translate.update_translations_for_source",
