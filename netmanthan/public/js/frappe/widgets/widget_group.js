...
netmanthan.provide("netmanthan.widget");

netmanthan.widget.widget_factory = {
	chart: ChartWidget,
	base: BaseWidget,
...
netmanthan.widget.make_widget = (opts) => {
	const widget_class = netmanthan.widget.widget_factory[opts.widget_type];
	if (widget_class) {
...
export default class WidgetGroup {
	...
	add_widget(widget) {
		let widget_object = netmanthan.widget.make_widget({
			...widget,
...
netmanthan.widget.WidgetGroup = WidgetGroup;
netmanthan.widget.SingleWidgetGroup = SingleWidgetGroup;
