...
netmanthan.ui.Scanner = class Scanner {
	constructor(options) {
		this.dialog = null;
		this.handler = null;
		...
		if (options.container) {
			...
			this.scan_area_id = netmanthan.dom.set_unique_id(this.$scan_area);
		}
		if (options.dialog) {
	...
	load_lib() {
		return netmanthan.require("/assets/netmanthan/node_modules/html5-qrcode/dist/html5-qrcode.min.js");
	}
};
