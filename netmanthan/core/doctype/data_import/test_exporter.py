...
from netmanthan.core.doctype.data_import.test_importer import create_doctype_if_not_exists
from netmanthan.tests.utils import netmanthanTestCase

doctype_name = "DocType for Export"


class TestExporter(netmanthanTestCase):
	def setUp(self):
		create_doctype_if_not_exists(doctype_name)

	def test_exports_specified_fields(self):
		if not netmanthan.db.exists(doctype_name, "Test"):
			...
			doc = netmanthan.get_doc(doctype_name, "Test")
	...
	def test_export_csv_response(self):
		...
		self.assertEqual(netmanthan.response["doctype"], doctype_name)
