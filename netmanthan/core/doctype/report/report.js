netmanthan.ui.form.on("Report", {
	refresh: function (frm) {
		if (frm.doc.is_standard === "Yes" && !netmanthan.boot.developer_mode) {
		...
		frm.add_custom_button(
			...
			function () {
				switch (doc.report_type) {
					case "Report Builder":
						netmanthan.set_route("List", doc.ref_doctype, "Report", doc.name);
						break;
					case "Query Report":
						netmanthan.set_route("query-report", doc.name);
						break;
					case "Script Report":
						netmanthan.set_route("query-report", doc.name);
						break;
