...
from netmanthan.utils import cint, convert_utc_to_system_timezone
from netmanthan.utils.background_jobs import get_workers
...
def serialize_worker(worker: Worker) -> netmanthan._dict:
