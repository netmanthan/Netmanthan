...
import netmanthan
from netmanthan.core.doctype.document_naming_settings.document_naming_settings import (
	DocumentNamingSettings,
)
from netmanthan.model.naming import NamingSeries, get_default_naming_series
from netmanthan.tests.utils import netmanthanTestCase
from netmanthan.utils import cint


class TestNamingSeries(netmanthanTestCase):
	def setUp(self):
		self.dns: DocumentNamingSettings = netmanthan.get_doc("Document Naming Settings")
	...
	def test_get_transactions(self):
		...
		existing_naming_series = netmanthan.get_meta("Webhook").get_field("naming_series").options
	...
	def test_updates_naming_options(self):
		...
		self.assertIn(test_series, netmanthan.get_meta("Webhook").get_naming_series_options())
