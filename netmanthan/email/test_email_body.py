...
import netmanthan
from netmanthan import safe_decode
from netmanthan.email.doctype.email_queue.email_queue import QueueBuilder, SendMailContext
from netmanthan.email.email_body import (
	get_email,
	get_header,
	inline_style_in_html,
	replace_filename_with_cid,
)
from netmanthan.email.receive import Email
from netmanthan.tests.utils import netmanthanTestCase


class TestEmailBody(netmanthanTestCase):
	def setUp(self):
		email_html = """
<div>
	<h3>Hey John Doe!</h3>
	<p>This is embedded image you asked for</p>
	<img embed="assets/netmanthan/images/netmanthan-favicon.svg" />
</div>
"""
		email_text = """
Hey John Doe!
...
"""
		...
		img_path = os.path.abspath("assets/netmanthan/images/netmanthan-favicon.svg")
	...
	def test_prepare_message_returns_already_encoded_string(self):
		...
		queue_doc = netmanthan.get_last_doc("Email Queue")
...
Content-Disposition: inline; filename="netmanthan-favicon.svg"
"""
...
"""
	...
	def test_replace_filename_with_cid(self):
		original_message = """
			<div>
				<img embed="assets/netmanthan/images/netmanthan-favicon.svg" alt="test" />
