...
from netmanthan.utils import add_to_date, get_link_to_form, today
from netmanthan.utils.data import is_html

# test_records = netmanthan.get_test_records('Auto Email Report')


class TestAutoEmailReport(netmanthanTestCase):
	def test_auto_email(self):
		netmanthan.delete_doc("Auto Email Report", "Permitted Documents For User")
...
def get_auto_email_report():
	if not netmanthan.db.exists("Auto Email Report", "Permitted Documents For User"):
		auto_email_report = netmanthan.get_doc(
			dict(
		...
		auto_email_report = netmanthan.get_doc("Auto Email Report", "Permitted Documents For User")
