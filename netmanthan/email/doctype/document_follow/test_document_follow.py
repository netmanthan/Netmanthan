...
import netmanthan
import netmanthan.desk.form.document_follow as document_follow
from netmanthan.desk.form.assign_to import add
from netmanthan.desk.form.document_follow import get_document_followed_by_user
from netmanthan.desk.form.utils import add_comment
from netmanthan.desk.like import toggle_like
from netmanthan.query_builder import DocType
from netmanthan.query_builder.functions import Cast_
from netmanthan.share import add as share
from netmanthan.tests.utils import netmanthanTestCase


class TestDocumentFollow(netmanthanTestCase):
	...
	def tearDown(self):
		...
		netmanthan.db.delete("Document Follow")
	...
	doc = netmanthan.get_doc(
		{
			...
			"doc.starts_on": netmanthan.utils.now(),
			"doc.ends_on": netmanthan.utils.add_days(netmanthan.utils.now(), 5),
...
def get_user(document_follow=None):
	...
	if netmanthan.db.exists("User", "test@docsub.com"):
		doc = netmanthan.delete_doc("User", "test@docsub.com")
	doc = netmanthan.new_doc("User")
...
def get_emails(event_doc, search_string):
	...
	return (
		netmanthan.qb.from_(EmailQueue)
