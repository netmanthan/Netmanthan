...
import netmanthan
from netmanthan.utils import get_bench_id, random_string
...
class RedisQueue:
	...
	def add_user(self, username, password=None):
		...
		return netmanthan._dict(user_settings) if is_created else {}

	@classmethod
	def get_connection(cls, username=None, password=None):
		rq_url = netmanthan.local.conf.redis_queue
