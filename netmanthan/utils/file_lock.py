...
Use `netmanthan.utils.synchroniztion.filelock` for process synchroniztion.
"""
...
import netmanthan
from netmanthan.utils import get_site_path, touch_file
...
def release_document_locks():
	...
	for doc in netmanthan.local.locked_documents:
		doc.unlock()
