...
from netmanthan.utils.background_jobs import get_queue, get_queue_list, get_redis_conn
from netmanthan.utils.scheduler import is_scheduler_disabled, is_scheduler_inactive
...
def doctor(site=None):
	...
	if site:
		...
		sites = netmanthan.utils.get_sites()
