...
from netmanthan.utils import add_to_date, get_datetime, getdate
...
def get_user_date_format():
	if getattr(netmanthan.local, "user_date_format", None) is None:
		netmanthan.local.user_date_format = netmanthan.defaults.get_global_default("date_format") or "yyyy-mm-dd"

	return netmanthan.local.user_date_format
...
def datetime_in_user_format(date_time):
	...
	from netmanthan.utils import formatdate
