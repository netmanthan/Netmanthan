import netmanthan
from netmanthan.utils.password import LegacyPassword


def execute():
	all_auths = netmanthan.db.sql(
	...
	netmanthan.reload_doctype("User")

	netmanthan.db.sql_ddl("""ALTER TABLE `__Auth` DROP COLUMN `salt`""")
