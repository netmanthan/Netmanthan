import netmanthan
from netmanthan.desk.doctype.notification_log.notification_log import make_notification_logs
...
def execute():
	...
	netmanthan.db.set_value("Email Account", {"auth_method": "OAuth"}, "awaiting_password", 1)
...
def get_system_managers():
	user_doctype = netmanthan.qb.DocType("User").as_("user")
	user_role_doctype = netmanthan.qb.DocType("Has Role").as_("user_role")
	return (
