...
import netmanthan
from netmanthan.utils import markdown, strip_html_tags


def execute():
	netmanthan.reload_doc("website", "doctype", "blog_post")

	for blog in netmanthan.get_all("Blog Post"):
		blog = netmanthan.get_doc("Blog Post", blog.name)
