		...
		if communication.timeline_doctype and communication.timeline_name:
			...
			values.append(
				"""({}, "{}", "timeline_links", "Communication", "{}", "{}", "{}", "{}", "{}", "{}")""".format(
					counter,
					str(name),
					netmanthan.db.escape(communication.name),
					netmanthan.db.escape(communication.timeline_doctype),
					netmanthan.db.escape(communication.timeline_name),
		...
		if communication.link_doctype and communication.link_name:
			...
			values.append(
				"""({}, "{}", "timeline_links", "Communication", "{}", "{}", "{}", "{}", "{}", "{}")""".format(
					...
					str(name),
					netmanthan.db.escape(communication.name),
					netmanthan.db.escape(communication.link_doctype),
					netmanthan.db.escape(communication.link_name),
					communication.creation,
					communication.modified,
					communication.modified_by,
				)
