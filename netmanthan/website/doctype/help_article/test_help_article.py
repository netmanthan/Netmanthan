...
# test_records = netmanthan.get_test_records('Help Article')


class TestHelpArticle(netmanthanTestCase):
	@classmethod
	def setUpClass(cls) -> None:
		cls.help_category = netmanthan.get_doc(
			{
		...
		cls.help_article = netmanthan.get_doc(
			{
	...
	def test_article_is_helpful(self):
		from netmanthan.website.doctype.help_article.help_article import add_feedback
	...
	def tearDownClass(cls) -> None:
		netmanthan.delete_doc(cls.help_article.doctype, cls.help_article.name)
		netmanthan.delete_doc(cls.help_category.doctype, cls.help_category.name)
