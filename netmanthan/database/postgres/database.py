...
from netmanthan.database.postgres.schema import PostgresTable
from netmanthan.database.utils import EmptyQueryValues, LazyDecode
from netmanthan.utils import cstr, get_table_name
...
class PostgresExceptionUtil:
	...
	def is_statement_timeout(e):
		return PostgresDatabase.is_timedout(e) or isinstance(e, netmanthan.QueryTimeoutError)
		...
		return [
			...
			where table_catalog='{}'
				...
				and table_schema='{}'""".format(
					netmanthan.conf.db_name, netmanthan.conf.get("db_schema", "public")
				)
			)
		]
