...
def pass_context(f):
	...
	def _func(ctx, *args, **kwargs):
		...
		try:
			ret = f(netmanthan._dict(ctx.obj), *args, **kwargs)
		except netmanthan.exceptions.SiteNotSpecifiedError as e:
			click.secho(str(e), fg="yellow")
			sys.exit(1)
		except netmanthan.exceptions.IncorrectSitePath:
...
def get_site(context, raise_err=True):
	try:
		...
		if raise_err:
			raise netmanthan.SiteNotSpecifiedError
		return None
...
def get_commands():
	...
	clickable_link = "\x1b]8;;https://netmanthanframework.com/docs\anetmanthanframework.com\x1b]8;;\a"
	all_commands = (
