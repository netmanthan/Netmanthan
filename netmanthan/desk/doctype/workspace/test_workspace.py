...
class TestWorkspace(netmanthanTestCase):
	def setUp(self):
		create_module("Test Module")

	def tearDown(self):
		netmanthan.db.delete("Workspace", {"module": "Test Module"})
		netmanthan.db.delete("DocType", {"module": "Test Module"})
		netmanthan.delete_doc("Module Def", "Test Module")
	...
	# 	if netmanthan.get_system_settings('country') == "France":
...
def create_module(module_name):
	module = netmanthan.get_doc(
		{"doctype": "Module Def", "module_name": module_name, "app_name": "netmanthan"}
	)
...
def create_workspace(**args):
	workspace = netmanthan.new_doc("Workspace")
