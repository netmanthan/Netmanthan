# Copyright (c) 2015, netmanthan Technologies Pvt. Ltd. and Contributors and Contributors
# License: MIT. See LICENSE

import netmanthan
from netmanthan.tests.utils import netmanthanTestCase

test_records = netmanthan.get_test_records("Note")


class TestNote(netmanthanTestCase):
	def insert_note(self):
		netmanthan.db.delete("Version")
	...
	def test_version(self):
		...
		version = netmanthan.get_doc("Version", dict(docname=note.name))
