...
// 		cy.window().its('netmanthan').then(netmanthan => {
// 			netmanthan.call("netmanthan.tests.ui_test_helpers.create_todo_records");
// 		});
// 	});
...
// 		cy.intercept('POST', '/api/method/netmanthan.model.utils.user_settings.save')
