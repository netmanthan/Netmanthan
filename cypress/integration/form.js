context("Form", () => {
	before(() => {
		...
		return cy
			...
			.its("netmanthan")
			.then((netmanthan) => {
				return netmanthan.call("netmanthan.tests.ui_test_helpers.create_contact_records");
			});
	});
	...
	it("create a new form", () => {
		...
		cy.intercept({
			method: "POST",
			url: "api/method/netmanthan.desk.form.save.savedocs",
		}).as("form_save");
	...
	it("validates behaviour of Data options validations in child table", () => {
		...
		cy.get('.netmanthan-control[data-fieldname="email_ids"]').as("table");
